...
goog.exportSymbol('proto.netbeam.ResourcePath', null, global);
 ...
 * @constructor
 */
proto.netbeam.ResourcePath = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.netbeam.ResourcePath.repeatedFields_, null);
};
goog.inherits(proto.netbeam.ResourcePath, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.netbeam.ResourcePath.displayName = 'proto.netbeam.ResourcePath';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.netbeam.ResourcePath.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.netbeam.ResourcePath.prototype.toObject = function(opt_includeInstance) {
  return proto.netbeam.ResourcePath.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.netbeam.ResourcePath} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.netbeam.ResourcePath.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.netbeam.ResourcePath}
 */
proto.netbeam.ResourcePath.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.netbeam.ResourcePath;
  return proto.netbeam.ResourcePath.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.netbeam.ResourcePath} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.netbeam.ResourcePath}
 */
proto.netbeam.ResourcePath.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.netbeam.ResourcePath.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.netbeam.ResourcePath.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.netbeam.ResourcePath} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.netbeam.ResourcePath.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.netbeam.ResourcePath.prototype.getPathList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};


/** @param {!Array<string>} value */
proto.netbeam.ResourcePath.prototype.setPathList = function(value) {
 ...
 */
proto.netbeam.ResourcePath.prototype.addPath = function(value, opt_index) {
 ...
 */
proto.netbeam.ResourcePath.prototype.clearPathList = function() {
  this.setPathList([]);
};
 ...
 * @return {string}
 */
proto.netbeam.Resource.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.netbeam.Resource.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
...
proto.netbeam.ResourceList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.netbeam.Resource.toObject, includeInstance),
    namespace: (f = msg.getNamespace()) && proto.netbeam.Namespace.toObject(includeInstance, f),
    parent: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
 ...
 * @return {!Array<!proto.netbeam.Resource>}
 */
proto.netbeam.ResourceList.prototype.getResourcesList = function() {
  return /** @type{!Array<!proto.netbeam.Resource>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.netbeam.Resource, 1));
};


/** @param {!Array<!proto.netbeam.Resource>} value */
...
/**
 * @param {!proto.netbeam.Resource=} opt_value
 * @param {number=} opt_index
 * @return {!proto.netbeam.Resource}
 */
proto.netbeam.ResourceList.prototype.addResources = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.netbeam.Resource, opt_index);
};
...
proto.netbeam.TileRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    namespace: (f = msg.getNamespace()) && proto.netbeam.Namespace.toObject(includeInstance, f),
    resource: (f = msg.getResource()) && proto.netbeam.ResourcePath.toObject(includeInstance, f),
...
proto.netbeam.TileRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.netbeam.ResourcePath;
      reader.readMessage(value,proto.netbeam.ResourcePath.deserializeBinaryFromReader);
...
proto.netbeam.TileRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.netbeam.ResourcePath.serializeBinaryToWriter
    );
  }
  f = message.getMetric();
  if (f.length > 0) {
...
/**
 * optional ResourcePath resource = 2;
 * @return {?proto.netbeam.ResourcePath}
 */
proto.netbeam.TileRequest.prototype.getResource = function() {
  return /** @type{?proto.netbeam.ResourcePath} */ (
    jspb.Message.getWrapperField(this, proto.netbeam.ResourcePath, 2));
};


/** @param {?proto.netbeam.ResourcePath|undefined} value */
