...
goog.exportSymbol('proto.netbeam.MetricSpecRequest', null, global);
 ...
 * @constructor
 */
proto.netbeam.MetricSpecRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.netbeam.MetricSpecRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.netbeam.MetricSpecRequest.displayName = 'proto.netbeam.MetricSpecRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.netbeam.MetricSpecRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.netbeam.MetricSpecRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.netbeam.MetricSpecRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.netbeam.MetricSpecRequest}
 */
proto.netbeam.MetricSpecRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.netbeam.MetricSpecRequest;
  return proto.netbeam.MetricSpecRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.netbeam.MetricSpecRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.netbeam.MetricSpecRequest}
 */
proto.netbeam.MetricSpecRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.netbeam.MetricSpecRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.netbeam.MetricSpecRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.netbeam.MetricSpecRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.netbeam.MetricSpecRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNamespace();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.netbeam.Namespace}
 */
proto.netbeam.MetricSpecRequest.prototype.getNamespace = function() {
  return /** @type{?proto.netbeam.Namespace} */ (
    jspb.Message.getWrapperField(this, proto.netbeam.Namespace, 1));
};
...
/** @param {?proto.netbeam.Namespace|undefined} value */
proto.netbeam.MetricSpecRequest.prototype.setNamespace = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.netbeam.MetricSpecRequest.prototype.clearNamespace = function() {
  this.setNamespace(undefined);
};
 ...
 * @return {boolean}
 */
proto.netbeam.MetricSpecRequest.prototype.hasNamespace = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.netbeam.RegisterMetricSpecRequest.prototype.getUnits = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};


/** @param {string} value */
proto.netbeam.RegisterMetricSpecRequest.prototype.setUnits = function(value) {
  jspb.Message.setProto3StringField(this, 6, value);
};
