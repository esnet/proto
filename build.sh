...
# Javascript
./node_modules/.bin/grpc_tools_node_protoc --js_out=import_style=commonjs,binary:./js --grpc_out=./js --plugin=protoc-gen-grpc=$GRPC_NODE_PLUGIN_PATH --proto_path=$PROTO_PATH netbeam.proto google/api/http.proto google/api/annotations.proto google/protobuf/compiler/plugin.proto 
./node_modules/.bin/grpc_tools_node_protoc --js_out=import_style=commonjs,binary:./js --grpc_out=./js --plugin=protoc-gen-grpc=$GRPC_NODE_PLUGIN_PATH --proto_path=$PROTO_PATH network.proto
