...
# Go netbeam builds
./node_modules/.bin/grpc_tools_node_protoc -I pond --go_out=go/netbeam --proto_path=$NETBEAM_PROTO_PATH netbeam.proto
./node_modules/.bin/grpc_tools_node_protoc -I pond --go_out=go/netbeam --proto_path=$NETBEAM_PROTO_PATH network.proto
...
# Go pond build
./node_modules/.bin/grpc_tools_node_protoc -I pond --go_out=go/pond --proto_path=$POND_PROTO_PATH pond.proto
